...
<div class="research-default display-default" data-type='research' data-id={$research.research_id}>
	{if isset($user) and $user.is_admin}
		<a class="edit-node button" href='{gl url="admin/research/view"}/{$research.research_id}'>Edit</a>
	{/if}
	...
	{if isset($research.people) and $research.people.count > 0}
		...
		<div class="persontable">
			{include "templates/people/teaser_list.tpl" people=$research.people group=false}
		</div>
	{/if}
	{if isset($research.publication) and $research.publication.count > 0}
		...
		{include "templates/publication/teaser_list.tpl" publication=$research.publication group=false}
	{/if}
</div>
{/if}
