...
<div class="publication-default display-default" data-type='publication' data-id={$publication.publication_id}>
	...
	<div class="persontable">
		{include "templates/people/teaser_list.tpl" people=$publication.people group=false}
	</div>
	{/if}
	...
	{if isset($publication.research) and $publication.research.count > 0}
		...
		{include "templates/research/teaser_list.tpl" research=$publication.research group=false}
	{/if}
